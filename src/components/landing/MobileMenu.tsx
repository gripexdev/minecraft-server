    ...
    <AnimatePresence>
      {open ? (
        <motion.div
          ...
          className="fixed inset-x-4 top-24 z-[60] lg:hidden"
        >
          <div className="glass-panel rounded-[2rem] p-5 shadow-[0_30px_90px_rgba(0,0,0,0.48)]">
            ...
            <div className="mt-4 rounded-[1.5rem] border border-white/8 bg-black/20 p-4">
              ...
              <p className="mt-2 text-lg font-semibold tracking-[0.1em] text-white">
                {SERVER_IP}
              </p>
