  ...
  return (
    <section id="vote" className="relative py-16 sm:py-20">
      <div className="container-shell">
        <Reveal>
          <div className="glass-panel rounded-[2.4rem] border border-emerald-300/14 bg-[linear-gradient(135deg,rgba(118,255,136,0.12),rgba(8,14,10,0.94)_42%,rgba(5,9,9,0.98)_100%)] p-6 sm:p-8 lg:p-10">
